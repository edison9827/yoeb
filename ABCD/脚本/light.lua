...
SetNeedSkillLineData(60,"元素淨化,nil|受傷時施放輔助,nil|信念浪湧,nil",nil,9,nil)
SetNeedSkillLineData(70,"鋼筋鐵骨,nil|先祖衛士,nil|持續時間延長輔助,nil",nil,4,nil)
SetNeedSkillLineData(80,"冰霜之捷,nil|盜獵者印記,nil|擊中時印記輔助,nil",nil,nil,nil)
SetNeedSkillLineData(90,"凋零之步,nil|召喚寒冰魔像,nil",nil,nil,nil)
SetNeedSkillLineData(99,"爆裂陷阱,nil|迅速組裝輔助,nil|機率中毒輔助,nil",18,nil,nil)
SetNeedSkillLineData(100,"閃電打擊,nil|夜刃輔助,nil|附加冰冷傷害輔助,nil|霜咬輔助,nil|附加閃電傷害輔助,nil|啟發輔助,nil|快速攻擊輔助,nil|機率中毒輔助,nil",nil,nil,nil)
